package assets.minecraft.shaders.animation;
...
public class ShaderProgram {
    ...
    private static String readShader(String fileName) {
        ...
        try {
            final InputStreamReader inputStreamReader = new InputStreamReader(ShaderProgram.class.getClassLoader().getResourceAsStream(String.format("assets/minecraft/shaders/animation/%s", fileName)));
